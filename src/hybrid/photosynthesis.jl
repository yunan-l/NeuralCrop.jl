function hybrid_photos_C3!(nn_model,
    ...
    photosynthesis_C3!(PFT, param, photopar, photos, crop.apar, pet_daylength, temp, co2; comp_vmax = comp_vmax)
...
function hybrid_photos_C4!(nn_model,
    ...
    # compute photosynthesis
    photosynthesis_C4!(PFT, param, photopar, photos, crop.apar, pet_daylength, temp; comp_vmax = comp_vmax)
